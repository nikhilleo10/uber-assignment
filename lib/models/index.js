...
export const models = {
  ...
  requested_rides: requestedRides(sequelize, Sequelize.DataTypes),
  completed_rides: completedRides(sequelize, Sequelize.DataTypes),
  incomplete_rides: incompleteRides(sequelize, Sequelize.DataTypes),
};
